...
```ShellSession
PATH/gff2gbSmallDNA.pl ref_species.annotation.gff ref_species.genes.gb
PATH/randomSplit.pl ref_species.genes.gb 100
```
Then, I generated a species file `ref_species`:
```ShellSession
PATH/new_species.pl --species=ref_species
```
